...
class TaskApp:
    ...
    def _save(self):
        ...
        self.state.save_user_params()               # → user_params.json（下次启动自动恢复）
        # 同步 LensParams 到 field_schema.json 的 default 字段
        import json, time
    ...
    def _on_export(self):
        ...
        try:
            ...
            result = export_process_card(filepath, lens_params=self.state.lens_params,
